...
namespace cn.vimfung.luascriptcore.modules.oo
{
	...
	public class LuaClassImport : LuaModule
	{
		...
		/// 导出类型
		/// </summary>
		private static Dictionary<int, Dictionary<string, Type>> _exportsClasses = new Dictionary<int, Dictionary<string, Type>> ();

		/// <summary>
		/// 检测是否为LuaObjectClass子类委托
		/// </summary>
		private static LuaCheckObjectSubclassDelegate _checkObjectSubclassDelegate;
		...
		[MonoPInvokeCallback (typeof (LuaCheckObjectSubclassDelegate))]
